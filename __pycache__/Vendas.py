...
def ConsultaCliente():
    ...
    texto = Text(janela, height=5, width=30)
...
def TelaCadCliente():
    ...
    emailadd = Entry(janela,width= 70)
    ...
    telefoneadd=Entry(janela,width= 70)
    ...
    enderecoadd = Entry(janela,width= 70)
    enderecoadd.grid(column=2, row=10, pady=5)
    botaovoltar = Button(janela, text="Voltar", command=janela.destroy, width=25)
    botaovoltar.grid(column=2, row=18)
    bottaoenviar = Button(janela,width=70, text="Confirmar cadastro do cliente", justify='center', command=lambda:ArmazenarDados)
